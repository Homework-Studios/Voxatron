...
public class KarteEinsSzene extends InGameScene {
    ...
    private boolean zeichneTutorial = true;
    ...
    public void init() {
        ...
        tutorialPaket = new ElementBatch(new Element[]{
                new ImageElement(new AssetManager<ImageAsset>().getAsset("Game/Tutorial"), Vector2.byScreenPercent(80, 18), Vector2.byScreenPercent(17, 15)),
                new TextElement(Vector2.byScreenPercent(71, 20), Vector2.byScreenPercent(18, 9), "Klicke zum verstecken", 30f, Jaylib.WHITE)
        }, true);
    ...
    public void update() {
        ...
        if (Raylib.IsMouseButtonPressed(Raylib.MOUSE_BUTTON_LEFT)) {
            zeichneTutorial = false;
        }

        if (!zeichneTutorial) tutorialPaket.setVisibility(false);
